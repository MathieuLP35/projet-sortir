 ...
 */
final class Version20240226134750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, etat_id INT NOT NULL, place_id INT NOT NULL, site_id INT NOT NULL, organiser_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, start_datetime DATETIME NOT NULL, duration INT DEFAULT NULL, limit_register_date DATETIME NOT NULL, max_register_qty INT NOT NULL, event_infos LONGTEXT DEFAULT NULL, INDEX IDX_3BAE0AA7D5E86FF (etat_id), INDEX IDX_3BAE0AA7DA6A219 (place_id), INDEX IDX_3BAE0AA7F6BD1646 (site_id), INDEX IDX_3BAE0AA7A0631C12 (organiser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
