 ...
 */
final class Version20240220101056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, etat_id INT NOT NULL, places_id INT NOT NULL, sites_id INT NOT NULL, organiser_id INT DEFAULT NULL, name VARCHAR(30) NOT NULL, start_datetime DATETIME NOT NULL, duration INT DEFAULT NULL, limit_register_date DATETIME NOT NULL, max_register_qty INT NOT NULL, event_infos LONGTEXT DEFAULT NULL, INDEX IDX_3BAE0AA7D5E86FF (etat_id), INDEX IDX_3BAE0AA78317B347 (places_id), INDEX IDX_3BAE0AA77838E496 (sites_id), INDEX IDX_3BAE0AA7A0631C12 (organiser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
